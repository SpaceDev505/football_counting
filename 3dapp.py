    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                left_3d_knee_angle = get_3D_angle(left_hip_3d, left_knee_3d, left_ank_3d)
                right_3d_knee_angle = get_3D_angle(right_hip_3d, right_knee_3d, right_ank_3d)
                ...
                if(y-pre_y !=0):
                    if((y- pre_y)>2):
                        ...
                        if(direct == 'Up' and pre_direct == 'Down'):
                            ...
                            if(left_3d_knee_angle > 80 or right_3d_knee_angle > 80):
                                if(left_3d_knee_angle > 80):
                                    pose_count[2] += 1
                                if(right_3d_knee_angle > 80):
                                    pose_count[3] += 1
                            # else:
                            #     if(y + radius > max(pos_y[4], pos_y[5])):
                            #         if(diff[0]> diff[1]):
                            #             pose_count[1] += 1
                            #         else:
                            #             pose_count[0] += 1
